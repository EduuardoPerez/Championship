/********************************************************************************
** Form generated from reading UI file 'regpartwindow.ui'
**
...
#ifndef UI_REGPARTWINDOW_H
#define UI_REGPARTWINDOW_H
...
public:
    ...
    void setupUi(QDialog *RegPartWindow)
    {
        if (RegPartWindow->objectName().isEmpty())
            RegPartWindow->setObjectName(QStringLiteral("RegPartWindow"));
        RegPartWindow->resize(800, 500);
        RegPartWindow->setAcceptDrops(false);
        QIcon icon;
        icon.addFile(QStringLiteral(":/logo/logo.png"), QSize(), QIcon::Normal, QIcon::Off);
        RegPartWindow->setWindowIcon(icon);
        deCurrDate = new QDateEdit(RegPartWindow);
        deCurrDate->setObjectName(QStringLiteral("deCurrDate"));
        deCurrDate->setEnabled(false);
        deCurrDate->setGeometry(QRect(690, 0, 110, 22));
        layoutWidget = new QWidget(RegPartWindow);
        ...
        pbInscribir = new QPushButton(layoutWidget);
        pbInscribir->setObjectName(QStringLiteral("pbInscribir"));

        horizontalLayout_65->addWidget(pbInscribir);
        ...
        retranslateUi(RegPartWindow);
        QObject::connect(pbRegresar, SIGNAL(clicked()), RegPartWindow, SLOT(close()));
        QObject::connect(pbSalir, SIGNAL(clicked()), RegPartWindow, SLOT(close()));

        QMetaObject::connectSlotsByName(RegPartWindow);
    } // setupUi

    void retranslateUi(QDialog *RegPartWindow)
    {
        RegPartWindow->setWindowTitle(QApplication::translate("RegPartWindow", "Championship", 0));
        deCurrDate->setDisplayFormat(QApplication::translate("RegPartWindow", "d/M/yyyy", 0));
        fechaeventotl_5->setText(QApplication::translate("RegPartWindow", "Fecha Inicio del Evento:", 0));
        deDateBegEv->setDisplayFormat(QApplication::translate("RegPartWindow", "dd/MM/yyyy", 0));
        cedulatl_5->setText(QApplication::translate("RegPartWindow", "C\303\251dula de identidad: ", 0));
        nombretl_5->setText(QApplication::translate("RegPartWindow", "Nombres: ", 0));
        apellidotl_5->setText(QApplication::translate("RegPartWindow", "Apellidos: ", 0));
        fechanacimientotl_5->setText(QApplication::translate("RegPartWindow", "Fecha de Nacimiento: ", 0));
        deBornDate->setDisplayFormat(QApplication::translate("RegPartWindow", "dd/MM/yyyy", 0));
        label_8->setText(QApplication::translate("RegPartWindow", "Registrar foto del participante: ", 0));
        pbExaminar->setText(QApplication::translate("RegPartWindow", "Examinar", 0));
        leDirPic->setText(QString());
        lePicture->setText(QString());
        pbInscribir->setText(QApplication::translate("RegPartWindow", "Inscribir", 0));
        pbSalir->setText(QApplication::translate("RegPartWindow", "Salir", 0));
        pbRegresar->setText(QApplication::translate("RegPartWindow", "Regresar", 0));
...
namespace Ui {
    class RegPartWindow: public Ui_RegPartWindow {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_REGPARTWINDOW_H
